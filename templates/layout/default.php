...
<head>
    ...
    <link rel="apple-touch-icon" href="https://app.ryudev.net/assets/images/512px.png" sizes="72x72">
    <link rel="apple-touch-icon" href="https://app.ryudev.net/assets/images/512px.png" sizes="96x96">
    <link rel="apple-touch-icon" href="https://app.ryudev.net/assets/images/512px.png" sizes="128x128">
    <link rel="apple-touch-icon" href="https://app.ryudev.net/assets/images/512px.png" sizes="144x144">
    <link rel="apple-touch-icon" href="https://app.ryudev.net/assets/images/512px.png" sizes="152x152">
    <link rel="apple-touch-icon" href="https://app.ryudev.net/assets/images/512px.png" sizes="192x192">
    <link rel="apple-touch-icon" href="https://app.ryudev.net/assets/images/512px.png" sizes="384x384">
    <link rel="apple-touch-icon" href="https://app.ryudev.net/assets/images/512px.png" sizes="512x512">
                ...
                <div class="container">
                    ...
                    <div class="card">
                        <div class="card-body" style="min-height: 400px;">
                            ...
                            ?>
                                <iframe src="https://worldview.earthdata.nasa.gov/?em=true" role="application" sandbox="allow-modals allow-scripts allow-same-origin allow-forms allow-popups" width="100%" height="400px" allow="fullscreen; autoplay;" loading="lazy"></iframe>
                            <?php } ?>
                        </div>
                    </div>
                </div>
